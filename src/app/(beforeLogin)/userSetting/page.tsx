...
export default function Page () {
  ...
  return (
    <div className={style.userSetting}>
      ...
      {20 <= progress && progress < 40 && <div className='pt-5 flex flex-col flex-grow'>
        <h1>생일을 선택해주세요.</h1>
      ...
      {40 <= progress && progress < 60 && <form className={style.mbtiForm} onSubmit={handleSubmit(onMbtiSubmit)}>
        <div>
          <div>
            <label htmlFor='i'>
              ...
              <input className='ml-2' id='i' type="radio" value='i' {...register('ie', {required: true})} />
            </label>
            <label htmlFor='e'>
              <input className='mr-2' id='e' type="radio" value='e' {...register('ie', {required: true})} />
          ...
          <div className={style.mbtiLabelWrapper}>
            <label htmlFor='s'>
              ...
              <input className='ml-2' id='s' type="radio" value='s' {...register('sn', {required: true})} />
            </label>
            <label htmlFor='n'>
              <input className='mr-2' id='n' type="radio" value='n' {...register('sn', {required: true})} />
          ...
          <div className={style.mbtiLabelWrapper}>
            <label htmlFor='f'>
              ...
              <input className='ml-2' id='f' type="radio" value='f' {...register('ft', {required: true})} />
            </label>
            <label htmlFor='t'>
              <input className='mr-2' id='t' type="radio" value='t' {...register('ft', {required: true})} />
          ...
          <div className={style.mbtiLabelWrapper}>
            <label htmlFor='p'>
              ...
              <input className='ml-2' id='p' type="radio" value='p' {...register('pj', {required: true})} />
            </label>
            <label htmlFor='j'>
              <input className='mr-2' id='j' type="radio" value='j' {...register('pj', {required: true})} />
